      ...
      return (
        <View style={styles.headerWrapStyle}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <TouchableOpacity onPress={() => navigation.navigate('CallPage', { receiver, currentUser })}>
              <MaterialIcons name="videocam" size={26} color={Colors.blackColor} style={{ marginRight: Sizes.fixPadding * 2.0 }} />
            </TouchableOpacity>
